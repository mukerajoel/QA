...
@section('content')
    <div class="wrapper">
        ...
        <form action="{{ route('r.update', $question->id) }}" method="POST" class="create-form">
            @method('put')
            @csrf

            <div class="create-form-title mb-3">
                <input name="title" type="hidden" id="title" placeholder="Question title" class="form-control"
